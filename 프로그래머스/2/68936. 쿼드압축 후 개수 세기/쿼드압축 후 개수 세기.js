// 4 * 4 배열을 네 부분으로 나눴을 때 각 부분마다 제일 좌측 상단의 시작점은 다음과 같다.
// 0, 0 / 0, 2 / 2, 0 / 2, 2
// 8 * 8 배열을 네 부분으로 나눴을 때 각 부분마다 제일 좌측 상단의 시작점은 다음과 같다.
// 0, 0 / 0, 4 / 4, 0 / 4, 4
...
// 4. 함수 반환값을 보고 isAllSame이 true라면 quadZone을 최종적으로 0과 1을 모으는 배열인 quadZoneArr에 넣어주고, 아니라면 다시 quadZone을 가지고 재귀적으로 divideToQuad()를 수행한다. (2-3 부터 4까지를 반복한다)
// 5. 최종적으로 quadZoneArr의 0과 1의 개수를 세어 정답을 반환한다.
